...
/**
 * An {@link InputFormat} for simple group placement， as comparative experiment to
 * {@link SpatialFileInputFormatGroupRaster3D}
 *
 * 看起来RecordReader可以通用，分组方式需要少量修改。
 */
@InterfaceAudience.Public
@InterfaceStability.Stable
public class SpatialFileInputFormatSimpleGroupRaster3D extends FileInputFormat<LongWritable, Raster3D> {
  private static final Log LOG = LogFactory.getLog(SpatialFileInputFormatSimpleGroupRaster3D.class);
