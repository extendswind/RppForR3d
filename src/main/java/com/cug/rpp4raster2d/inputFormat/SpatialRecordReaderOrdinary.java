...
//    isFirstColGroup = inputSplit.isFirstColGroup; // useless
  ...
  public boolean nextKeyValue() throws IOException {
    ...
    if (paths.length == 4) {
      ...
      CellIndexInfo cell1 = CellIndexInfo.getGridCellInfoFromFilename(paths[0].toString());
      CellIndexInfo cell2 = CellIndexInfo.getGridCellInfoFromFilename(paths[1].toString());
